...
public class InventoryCableConnectorFilteredBlockEntity extends TileEntityInventoryCableConnectorBase implements MenuProvider {
	private SimpleContainer filter = new SimpleContainer(9) {

		@Override
		public boolean stillValid(Player p_59619_) {
			return InventoryCableConnectorFilteredBlockEntity.this.stillValid(p_59619_);
		}
	};

	public InventoryCableConnectorFilteredBlockEntity(BlockPos pos, BlockState state) {
		super(RegisterBlockEntityTypes.INVENTORY_CABLE_CONNECTOR_FILTERED, pos, state);
	}
