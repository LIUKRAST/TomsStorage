...
public class CraftingTerminalBlockEntity extends StorageTerminalBlockEntity {
	private AbstractContainerMenu CRAFTING_CONTAINER = new AbstractContainerMenu(MenuType.CRAFTING, 0) {
		@Override
		...
		//TODO: Check if this is correct in 1.19
		@Override
	...
	private final CraftingContainer craftMatrix = new CraftingContainer(CRAFTING_CONTAINER, 3, 3);
	...
	public CraftingTerminalBlockEntity(BlockPos pos, BlockState state) {
		super(RegisterBlockEntityTypes.CRAFTING_TERMINAL, pos, state);
	}
